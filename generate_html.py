...
<body>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="axesDropdown">
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="../../axe1/html_pages/travaux_GT1.html">GT1</a></li>
                                    <li><a class="dropdown-item" href="../../axe1/html_pages/travaux_GT1.html">GT2</a></li>
                                    <li><a class="dropdown-item" href="../../axe1/html_pages/travaux_GT3.html">GT3</a></li>
                                </ul>
                            </li>
                            <li class="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle">Axe 2</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="../../axe2/html_pages/travaux_GT4.html">GT4</a></li>
                                    <li><a class="dropdown-item" href="../../axe2/html_pages/travaux_GT5.html">GT5</a></li>
                                    <li><a class="dropdown-item" href="../../axe2/html_pages/travaux_GT6.html">GT6</a></li>
                                </ul>
                            </li>
                            <li class="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle">Axe 3</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="../../axe3/html_pages/travaux_ethique.html">Enjeux éthiques</a></li>
                                    <li><a class="dropdown-item" href="../../axe3/html_pages/travaux_juridique.html">Questions juridiques</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                  <li class="nav-item">
                    <a class="nav-link text-gray-400 text-xl transition hover:text-gray-400/75" href="../actualites.html">Actualités</a>
                </li>
                  <li class="nav-item">
    ...
    <nav aria-label="breadcrumb" class="container my-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="../axe1.html">Axe 1</a></li>
            <li class="breadcrumb-item"><a href="../axe1/GT{gt_number}.html">GT{gt_number}</a></li>
            <li class="breadcrumb-item"><a href="../axe1/GT{gt_number}/travaux_GT{gt_number}.html">Travaux du GT{gt_number}</a></li>
        </ol>
    </nav>
    ...
    <footer class="bg-light py-3">
        <div class="container d-flex justify-content-between align-items-center">
          ...
          <div class="ms-5">
            <a href="../../credits.html" class="mx-2">Crédits</a>
          </div>
          <div class="ms-5">
            <a href="../../mentions_legales.html" class="mx-2">Mentions légales</a>
          </div>
          <div class="ms-5">
